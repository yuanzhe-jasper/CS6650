...
public class MultiThreadsProcessor {
  ...
  public void execute() throws InterruptedException, IOException {
    ...
    System.out.println("==================");
    System.out.println("Statistics for New Album requests");

    System.out.println("==================");
    calculateStatistics(records, "Album");
    //get statistics for POST requests
    System.out.println("Statistics for Reaction requests");
    calculateStatistics(records, "Reaction");
